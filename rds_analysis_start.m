...
function [text1, text2, AF, N, PIN, Hour, Minutes,LocalTimeOffset,Y,M,D,PI,PTY] = rds_analysis_start(index, data, text1, text2, AF, N, PIN, Hour, Minutes, LocalTimeOffset, Y, M, D, PI, PTY)
